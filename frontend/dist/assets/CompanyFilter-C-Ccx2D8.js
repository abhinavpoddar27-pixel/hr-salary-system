import{a as p,j as t,T as m}from"./index-Bol13R13.js";import{u}from"./useQuery-CHoap1q6.js";function x({className:o="",compact:n=!1}){var s;const{selectedCompany:r,setSelectedCompany:i}=p(),{data:a}=u({queryKey:["companies"],queryFn:()=>m.get("/settings/companies"),staleTime:3e5,retry:0}),l=((s=a==null?void 0:a.data)==null?void 0:s.data)||[];return t.jsxs("select",{value:r,onChange:e=>i(e.target.value),className:`

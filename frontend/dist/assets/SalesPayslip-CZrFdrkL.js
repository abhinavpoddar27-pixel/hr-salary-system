const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/html2pdf-Bmx8y2-H.js","assets/index-Bb-WfO-A.js","assets/index-DMgrrbZe.css"])))=>i.map(i=>d[i]);
import{aT as M,dS as O,Y as B,u as J,r as q,j as t,c as H,z as C,dT as G}from"./index-Bb-WfO-A.js";import{u as V}from"./useQuery-BtHuk6_F.js";const T=["","January","February","March","April","May","June","July","August","September","October","November","December"];function h(e){return new Intl.NumberFormat("en-IN",{maximumFractionDigits:2,minimumFractionDigits:2}).format(Number(e||0))}function Q(e){if(!e)return"—";const s=/^(\d{4})-(\d{2})-(\d{2})/.exec(e);return s?`${s[3]}/${s[2]}/${s[1]}`:e}function Y(e){const{employee:s,period:c,days:a,earnings:i,totalEarnings:p,deductions:d,totalDeductions:N,netSalary:v,status:m,bank:n,computedAt:f,finalizedAt:b,finalizedBy:r}=e,y=!["finalized","paid"].includes(m),x=(m||"computed").toUpperCase(),$=(i||[]).filter(l=>(l.amount||0)>0).map(l=>`<tr><td style="padding:4px 8px;border:1px solid #ddd;">${l.label}</td>

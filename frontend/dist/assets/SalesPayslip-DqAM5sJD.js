const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/html2pdf-DNFQKZuY.js","assets/index-D0nFWKfe.js","assets/index-BhRR70Sz.css"])))=>i.map(i=>d[i]);
import{aU as M,dT as O,Z as B,u as J,r as q,j as t,c as H,z as C,dU as G}from"./index-D0nFWKfe.js";import{u as U}from"./useQuery-BxpXoG8C.js";const T=["","January","February","March","April","May","June","July","August","September","October","November","December"];function h(e){return new Intl.NumberFormat("en-IN",{maximumFractionDigits:2,minimumFractionDigits:2}).format(Number(e||0))}function V(e){if(!e)return"—";const s=/^(\d{4})-(\d{2})-(\d{2})/.exec(e);return s?`${s[3]}/${s[2]}/${s[1]}`:e}function Q(e){const{employee:s,period:c,days:a,earnings:i,totalEarnings:p,deductions:d,totalDeductions:N,netSalary:v,status:m,bank:n,computedAt:f,finalizedAt:b,finalizedBy:r}=e,y=!["finalized","paid"].includes(m),x=(m||"computed").toUpperCase(),$=(i||[]).filter(l=>(l.amount||0)>0).map(l=>`<tr><td style="padding:4px 8px;border:1px solid #ddd;">${l.label}</td>
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:12px;font-size:10px;">
      ...
      <tr>
        <td style="padding:3px 0;"><strong>Date of Joining:</strong></td><td>${V(s.doj)}</td>

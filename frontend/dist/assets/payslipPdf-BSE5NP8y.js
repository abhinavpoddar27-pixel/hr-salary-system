...
import{aV as G}from"./index-DM3NomFG.js";const V=["","January","February","March","April","May","June","July","August","September","October","November","December"];function o(n){return Math.round(n||0).toLocaleString("en-IN")}const $="padding:3px 4px;border:1px solid #999;font-size:9px;",e=$+"text-align:right;font-family:monospace;",r="padding:4px 5px;border:1px solid #666;font-size:8px;font-weight:bold;background:#d9e2f3;text-align:center;";function Y(n,x,y,u){var g,_,D,E,S,k,A,T,L,N,z,H,O,C,M,j,R,F,I,U,J,B;const f=(x==null?void 0:x.company_name)||"Company",p=V[y]||y,c={},w="__PERMANENT__";c[w]={label:"PERMANENT STAFF",employees:[]};for(const l of n){const b=l.employee,a=l.attendance||{},d=l.otPay||((_=(g=l.earnings)==null?void 0:g.find(s=>s.label==="OT Pay"))==null?void 0:_.amount)||0,v=l.edPay||((E=(D=l.earnings)==null?void 0:D.find(s=>s.label==="Extra Duty Pay"))==null?void 0:E.amount)||0,q=l.takeHome||(l.totalPayable||l.netSalary||0)+v,K={code:b.code,name:b.name||b.code,designation:b.designation||b.department||"",grossSalary:l.grossSalary||l.grossEarned||0,basic:((k=(S=l.earnings)==null?void 0:S.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("Basic")}))==null?void 0:k.amount)||0,hra:((T=(A=l.earnings)==null?void 0:A.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("HRA")}))==null?void 0:T.amount)||0,cca:0,conv:((N=(L=l.earnings)==null?void 0:L.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("Conveyance")}))==null?void 0:N.amount)||0,totalEarned:l.grossEarned||0,otPay:d,edPay:v,advance:((H=(z=l.deductions)==null?void 0:z.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("Advance")}))==null?void 0:H.amount)||0,pf:((C=(O=l.deductions)==null?void 0:O.find(s=>{var i,m;return((i=s.label)==null?void 0:i.includes("PF"))&&!((m=s.label)!=null&&m.includes("Employer"))}))==null?void 0:C.amount)||0,esi:((j=(M=l.deductions)==null?void 0:M.find(s=>{var i,m;return((i=s.label)==null?void 0:i.includes("ESI"))&&!((m=s.label)!=null&&m.includes("Employer"))}))==null?void 0:j.amount)||0,wlf:0,tds:((F=(R=l.deductions)==null?void 0:R.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("TDS")}))==null?void 0:F.amount)||0,pt:((U=(I=l.deductions)==null?void 0:I.find(s=>{var i;return(i=s.label)==null?void 0:i.includes("Professional")}))==null?void 0:U.amount)||0,lateDed:((B=(J=l.deductions)==null?void 0:J.find(s=>{var i,m;return((i=s.label)==null?void 0:i.includes("LOP"))||((m=s.label)==null?void 0:m.includes("Late"))}))==null?void 0:B.amount)||0,days:a.days_present||0,el:a.el_used||0,sundays:a.paid_sundays||0,totalDays:a.total_payable_days||0,payable:l.grossEarned||0,netPayable:l.netSalary||0,takeHome:q,department:b.department||""},W=l.is_contractor===1||l.is_contractor===!0,P=(b.department||"").toUpperCase();if(W||l.is_contractor===void 0&&(P.includes("CONT")||P.includes("LAMBU")||P.includes("MEERA")||P.includes("KULDEEP")||P.includes("JIWAN")||P.includes("SUNNY")||P.includes("AMAR"))){const s=b.department||"CONTRACTOR";c[s]||(c[s]={label:s,employees:[]}),c[s].employees.push(K)}else c[w].employees.push(K)}let h=`<div style="font-family:Arial,sans-serif;padding:10px;">
  ...
  </div>`}async function tt(n,x){const y=(await G(async()=>{const{default:p}=await import("./html2pdf-11L17zHD.js").then(c=>c.h);return{default:p}},__vite__mapDeps([0,1,2]))).default,u=Q(n),f=document.createElement("div");f.innerHTML=u,document.body.appendChild(f);try{await y().set({margin:[5,5,5,5],filename:`Payslip_${n.employee.code}_${n.period.monthName}_${n.period.year}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"}}).from(f).save()}finally{document.body.removeChild(f)}}async function et(n,x,y,u){const f=(await G(async()=>{const{default:h}=await import("./html2pdf-11L17zHD.js").then(t=>t.h);return{default:h}},__vite__mapDeps([0,1,2]))).default,p=Y(n,x,y,u),c=document.createElement("div");c.innerHTML=p,document.body.appendChild(c);const w=V[y]||y;try{await f().set({margin:[5,5,5,5],filename:`Salary_Slip_${w}_${u}.pdf`,image:{type:"jpeg",quality:.95},html2canvas:{scale:2},jsPDF:{unit:"mm",format:"a4",orientation:"landscape"},pagebreak:{mode:["css","legacy"]}}).from(c).save()}finally{document.body.removeChild(c)}}export{et as a,tt as d};

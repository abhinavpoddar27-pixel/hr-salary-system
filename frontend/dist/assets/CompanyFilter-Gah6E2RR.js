import{a as p,j as t,P as m}from"./index-DPfNkfVb.js";import{u}from"./useQuery-CMTN33IP.js";function x({className:o="",compact:n=!1}){var s;const{selectedCompany:r,setSelectedCompany:i}=p(),{data:a}=u({queryKey:["companies"],queryFn:()=>m.get("/settings/companies"),staleTime:3e5,retry:0}),l=((s=a==null?void 0:a.data)==null?void 0:s.data)||[];return t.jsxs("select",{value:r,onChange:e=>i(e.target.value),className:`

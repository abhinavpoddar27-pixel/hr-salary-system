import{a as p,b as u,j as s,V as m}from"./index-Bn43V4IX.js";function c({className:n="",compact:o=!1}){var t;const{selectedCompany:r,setSelectedCompany:l}=p(),{data:a}=u({queryKey:["companies"],queryFn:()=>m.get("/settings/companies"),staleTime:3e5,retry:0}),i=((t=a==null?void 0:a.data)==null?void 0:t.data)||[];return s.jsxs("select",{value:r,onChange:e=>l(e.target.value),className:`
